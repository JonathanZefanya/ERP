var AddPaymentDetail = function () {
    ...
    PaymentsDetailItem.FreeQuantity = $("#FreeQuantity").val();
...
function UpdatePaymentDetail(button) {
    ...
    var _FreeQuantity = parseFloat($("#FreeQuantity" + _PaymentDetailId).val());
    ...
    PaymentDetailCRUDViewModel.FreeQuantity = _FreeQuantity;
