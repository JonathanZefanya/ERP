namespace BusinessERP.Pages
{
    public static class MainMenu
    {
        ...
        public static class DamageItemReport
        {
            public const string PageName = "Damage Item Report";
            public const string RoleName = "Damage Item Report";
            public const string Path = "/DamageItemReport/Index";
        }
